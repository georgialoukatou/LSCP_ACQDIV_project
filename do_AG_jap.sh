...
case $ALGO in
    "AGu")
        GRAMMARFILE=$ABSPATH/grammars/Colloc0_jap.lt
        LEVEL="Colloc0"
        ;;
    "AGc3sf")
        GRAMMARFILE=$ABSPATH/grammars/Coll3syllfnc_jap.lt
        LEVEL="Word"
        ;;
    *)
...
# 7)
python $REDUCEPRSFILE -n $NRED $RESFOLDER/$OUTFILE[0-5].prs || exit 1
