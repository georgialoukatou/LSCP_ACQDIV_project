...
%onsets = {};
open(ONSETS, "<$scriptdir/$language-ValidOnsets.txt") or die("Couldn't open $scriptdir/$language-ValidOnsets.txt\n");
...
%vowels = {};
open(VOWELS, "<$scriptdir/$language-vowels.txt") or die("Couldn't open $scriptdir/$language-vowels.txt\n");
my $vowels = <VOWELS>;
print "$vowels";
close(VOWELS);
